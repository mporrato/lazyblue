...
RUN <<-'EOT' sh
    ...
    rpm-ostree install gcc gnome-tweaks distrobox tmux vim ripgrep htop tailscale stow screen micro \
        intel-media-driver mesa-vdpau-drivers-freeworld gstreamer1-plugin-libav gstreamer1-plugins-bad-free-extras \
        gstreamer1-plugins-bad-freeworld gstreamer1-plugins-ugly gstreamer1-vaapi --allow-inactive
